...
<main>
    ...
    <div class="container py-1">
        <a href="{{route('frhlibros.pdf')}}" class="btn btn-custom" target="_blank">PDF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf-fill" viewBox="0 0 16 16">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $frhlibro->isbn }}</td>
                        <td>{{ $frhlibro->fecha_publicacion }}</td>
                        <td>{{ $frhlibro->enlace }}</td>
                        <td class="text-center">
                            <!-- Mostrar el enlace al PDF si está disponible -->
                            @if ($frhlibro->archivo_pdf)
                                <a href="{{ asset('pdfs/frhlibros/' . $frhlibro->archivo_pdf) }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
