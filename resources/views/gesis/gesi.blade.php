        ...
        <main>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="py-3 text-left text-primary">
                    <h2><b>Gestión de la Investigación</b></h2>
                </div>
                <form action="{{url('gesis')}}" method="post" enctype="multipart/form-data">
                    <div class="row g-3">
                        @csrf
                        <div class="mb-2 row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="tipo_doc" placeholder="" value="{{old('tipo_doc')}}" required>
                        </div>

                        <div class="col-md-9">
                            <label for="titulo" class="form-label">Titulo del documento</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="universidad" type="text" class="form-control shiny-bound-input" placeholder="" value="{{old('universidad')}}" required>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="descripcion" placeholder="" value="{{old('descripcion')}}">
                        </div>
