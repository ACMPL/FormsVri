...
<main>
    <div class="container py-4">
        <h2 class="tituloA">Gestión de la investigación</h2>
    </div>
    <div class="container py-1">
        <a href="{{route('gesis.pdf')}}" class="btn btn-custom" target="_blank">PDF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf-fill" viewBox="0 0 16 16">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $gesi->tipo_doc }}</td>
                        <td>{{ $gesi->titulo }}</td>
                        <td>{{ $gesi->universidad }}</td>
                        <td>{{ $gesi->fecha_publicacion }}</td>
                        <td>{{ $gesi->descripcion }}</td>
                        <td class="text-center">
                            <!-- Mostrar el enlace al PDF si está disponible -->
                            @if ($gesi->archivo_pdf)
                                <a href="{{ asset('pdfs/gesis/' . $gesi->archivo_pdf) }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
