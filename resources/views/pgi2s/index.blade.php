...
<main>
    <div class="container py-4">
        <h2 class="tituloA">Participación de grupos de investigación</h2>
    </div>
    <div class="container py-1">
        <a href="{{route('pgi2s.pdf')}}" class="btn btn-custom" target="_blank">PDF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf-fill" viewBox="0 0 16 16">
            ...
            <table class="table table-bordered table-hover">
                <thead class="table-dark text-center">
                    <tr>
                        ...
                        <th>Grupo</th>
                        <th>Nivel</th>
                        <th>vigencia_inicial</th>
                        <th>vigencia_final</th>
                        <th>Archivo</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $pgi2->grupo }}</td>
                        <td>{{ $pgi2->nivel }}</td>
                        <td>{{ $pgi2->vigencia_inicial }}</td>
                        <td>{{ $pgi2->vigencia_final }}</td>
                        <td class="text-center">
                            <!-- Mostrar el enlace al PDF si está disponible -->
                            @if ($pgi2->archivo_pdf)
                                <a href="{{ asset('pdfs/pgi2s/' . $pgi2->archivo_pdf) }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
