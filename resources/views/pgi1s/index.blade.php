...
<main>
    ...
    <div class="container py-1">
        <a href="{{route('pgi1s.pdf')}}" class="btn btn-custom" target="_blank">PDF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf-fill" viewBox="0 0 16 16">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $pgi1->grupo }}</td>
                        <td>{{ $pgi1->rol }}</td>
                        <td>{{ $pgi1->participantes }}</td>
                        <td>{{ $pgi1->fecha }}</td>
                        <td class="text-center">
                            <!-- Mostrar el enlace al PDF si está disponible -->
                            @if ($pgi1->archivo_pdf)
                                <a href="{{ asset('pdfs/pgi1s/' . $pgi1->archivo_pdf) }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
