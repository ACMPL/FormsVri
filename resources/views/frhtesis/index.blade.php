...
<main>
    <div class="container py-4">
        <h2 class="tituloA">Formación de Recursos Humanos</h2>
    </div>
    <div class="container py-1">
        <a href="{{route('frhtesis.pdf')}}" class="btn btn-custom" target="_blank">PDF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf-fill" viewBox="0 0 16 16">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $frhtesi->titulo_tesis }}</td>
                        <td>{{ $frhtesi->facultad }}</td>
                        <td>{{ $frhtesi->escuela_profesional }}</td>
                        <td>{{ $frhtesi->nivel_tesis }}</td>
                        <td>{{ $frhtesi->fecha_evaluacion }}</td>
                        <td class="text-center">
                            <!-- Mostrar el enlace al PDF si está disponible -->
                            @if ($frhtesi->archivo_pdf)
                                <a href="{{ asset('pdfs/frhtesis/' . $frhtesi->archivo_pdf) }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
