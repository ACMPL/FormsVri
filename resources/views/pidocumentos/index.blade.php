...
<style>
    ...
    <main>
        <div class="container py-4">
            <h2 class="tituloA">Documentos</h2>
        </div>
        <div class="container py-1">
            <a href="{{route('pidocumentos.pdf')}}" class="btn btn-custom" target="_blank">PDF <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf-fill" viewBox="0 0 16 16">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $pidocumento->cantidad_autores }}</td>
                        <td>{{ $pidocumento->fecha_publicacion }}</td>
                        <td>{{ $pidocumento->enlace_documento }}</td>
                        <td class="text-center">
                            <!-- Mostrar el enlace al PDF si está disponible -->
                            @if ($pidocumento->archivo_pdf)
                                <a href="{{ asset('pdfs/pidocumentos/' . $pidocumento->archivo_pdf) }}" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
